...
# python face_demo.py C:\Users\rehbe\Downloads\face_demo2.jpg
...
def toggle_theme():
    ...
    session['darkMode'] = not current_mode 
    return '', 204
...
def facereg():
    if request.method == "POST":
        ...
        if len(user_record) != 1:
            ...
            return render_template("camera.html", retry=True, message=1)
        ...
        try:
            ...
            if not uploaded_face_encodings:
                ...
                return render_template("camera.html", retry=True, message=2)  
            ...
            if not reference_face_encodings:
                ...
                return render_template("camera.html", retry=False, message=5) 
            ...
            if face_distances[0] <= 0.4:
                ...
                return render_template("camera.html", retry=True, message=3) 
        except Exception as e:
            flash(f"Error processing image: {str(e)}")
            return render_template("camera.html", retry=True, message=4) 
